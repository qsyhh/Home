...
function pointerMoveHandler(e) {
  if (pointerDown) updatePaddleByPointer(e);
}
...
// 触摸事件
canvas.addEventListener("touchstart", pointerDownHandler, { passive: true });
canvas.addEventListener("touchend",   pointerUpHandler,   { passive: true });
canvas.addEventListener("touchmove",  pointerMoveHandler, { passive: true });